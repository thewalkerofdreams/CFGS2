...
public class Main {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        //Pruebas AsistenciaMedica
        PersistenciaAsistenciaMedica persistenciaAsistenciaMedica = new PersistenciaAsistenciaMedica();
        //Get
        AsistenciaMedica asistenciaMedica = persistenciaAsistenciaMedica.getAsistenciaMedica(session, 5);
        System.out.println(asistenciaMedica);

        //Insert
        //persistenciaAsistenciaMedica.insertAsistenciaMedica(session, new AsistenciaMedica(seguro, "Dolor de tripa", "Huelva2"));

        //Update
        asistenciaMedica.setBreveDescripcion("Una Nuevaaaaaaaaaaa!");
        persistenciaAsistenciaMedica.updateAsistenciaMedica(session, asistenciaMedica);
        System.out.println(asistenciaMedica);

        //Delete
        persistenciaAsistenciaMedica.deleteAsistenciaMedica(session, 3);
    }
}