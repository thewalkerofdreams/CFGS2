...
public class MainTabbetActivityVM extends AndroidViewModel {
    ...
    private ArrayList<ClsRoute> _routasSeleccionadas;
    ...
    public MainTabbetActivityVM(Application application){
        ...
        _routasSeleccionadas = new ArrayList<>();
    }
    ...
    public ArrayList<ClsRoute> get_routasSeleccionadas() {
        return _routasSeleccionadas;
    }

    public void set_routasSeleccionadas(ArrayList<ClsRoute> _routasSeleccionadas) {
        this._routasSeleccionadas = _routasSeleccionadas;
    }
