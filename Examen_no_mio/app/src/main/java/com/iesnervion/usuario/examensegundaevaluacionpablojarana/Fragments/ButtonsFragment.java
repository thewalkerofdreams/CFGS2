...
public class ButtonsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnMostrarLista=(Button)v.findViewById(R.id.btnMostrarLista);
        btnInsertar=(Button)v.findViewById(R.id.btnInsert);
        btnMostrarLista.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.instanceListFragment();
            }
        });
        btnInsertar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.instanceAddJugadorFragment();
            }
        });
        return v;
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void instanceListFragment();
        void instanceAddJugadorFragment();
    }
}
